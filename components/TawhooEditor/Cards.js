...
const Cards = ({ tawhoos, itemsPerPage }) => {
  ...
  const currentItems = tawhoos.slice(indexOfFirst, indexOfLast);
  ...
  return (
    <div>
      ...
      <Pagination
        ...
        totalItemsCount={tawhoos.length}
